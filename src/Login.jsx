    ...
    return (
        <div className="flex h-screen w-full font-sans overflow-hidden bg-white text-[#111]">
            <div className="hidden lg:flex w-[45%] bg-[#063925] flex-col justify-between p-16 text-white relative overflow-hidden">
                <div className="font-medium tracking-widest text-base font-bold opacity-90 uppercase z-10 pl-[2px]">Finbridge</div>

                <div className="max-w-md z-10">
                    <h1 className="text-6xl font-serif tracking-tight mb-6 leading-[1.1] -ml-[3px]">
                        Money, <br />
                        Translated.
                    </h1>
                ...
                <div className="w-full max-w-[480px] bg-white px-10 pt-12 pb-10 sm:px-12 sm:pt-14 sm:pb-12 rounded-3xl shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)] border border-gray-200/60 ring-1 ring-black/5">
                    ...
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-8 gap-4 opacity-75">
                            ...
                            <span className="text-xs text-gray-900 font-medium tracking-wide uppercase">Establishing secure connection...</span>
                        </div>
                    ) : (
                        <div className="space-y-8">
                            ...
                            >
                                <span className="font-medium text-[15px] tracking-wide">Connect Bank Account</span>
                            ...
                            <div className="space-y-5">
                                <div className="flex items-center justify-center gap-2 opacity-90">
                                    ...
                                    <span className="text-[13px] font-medium text-gray-600">End-to-end encrypted via Plaid</span>
                                </div>

                                <p className="text-[11px] text-gray-600 leading-relaxed text-center max-w-xs mx-auto">
                                    By connecting, you agree to Finbridge's <a href="https://plaid.com/legal/#consumers" target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-black underline decoration-gray-300 hover:decoration-gray-500 underline-offset-2 transition-colors">Terms</a> and <a href="https://plaid.com/legal/#privacy-policy" target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-black underline decoration-gray-300 hover:decoration-gray-500 underline-offset-2 transition-colors">Privacy Policy</a>.
                                </p>
                            </div>
                        </div>
                    )}
