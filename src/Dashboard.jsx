...
export default function Dashboard() {
    ...
    const transactions = React.useMemo(() => [
        ...
        { id: 3, name: 'Google Inc. Payroll', date: getDate(3, currentLocale), category: t('dashboard.categories.income', 'Income'), amount: 2800.00, logo: 'https://www.google.com/s2/favicons?domain=google.com&sz=128' },
